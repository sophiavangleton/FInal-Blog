...
description: |
  I want to use an interaction between two catagorical variables, trial type and cue stimulus interval, and plot them by reaction time. 
author:
...
custom_colors <- c("#009EB0", "#B9E192", '#C44601', '#F194B8') #color blind safe pallet
