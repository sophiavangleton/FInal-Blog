...
legend("center", legend = c("Congruent", "Incongruent"), col = c("black", "#AABA99"), pch = c(19, 17), bty = "n", cex = .8)
...
legend("center", legend = c("Short CSI", "Long CSI"), col = c("black", "#198BA9"), pch = c(19, 17), bty = "n", cex = .8)
